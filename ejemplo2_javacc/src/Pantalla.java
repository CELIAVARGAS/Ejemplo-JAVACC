...
public class Pantalla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESE ENTRADA.                                 POR EJEMPLO:          X=1,Y=2,Z=3; 1+2*3+Z             (letras X,Y,Z en mayuscula)*");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Adder adder = new Adder(new StringReader(areaEntrada.getText()));
            int numero = adder.Start();
            areaSalida.setText(String.valueOf(numero));
        } catch (Exception e) {
